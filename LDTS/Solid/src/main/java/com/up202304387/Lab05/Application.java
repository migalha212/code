package com.up202304387.Lab05;


import com.up202304387.Lab05.sumProviders.*;
import com.up202304387.Lab05.shapes.*;
...
public class Application {
    public static void main(String[] args) {
        ...
        AreaStringOutputter stringOutputter = new
                AreaStringOutputter(aggregator);
        AreaXMLOutputter xmlOutputter = new
                AreaXMLOutputter(aggregator);
        ...
        AreaStringOutputter cityStringOutputter = new
                AreaStringOutputter(city);
        AreaXMLOutputter cityXmlOutputter = new
                AreaXMLOutputter(city);
